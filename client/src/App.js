...
import videoDescription from "./pages/videoDescription/videoDescription.jsx";
      ...
      <Router>
        <div>
          <Switch>
            ...
            <ProtectedRoute path="/video/:videoID" component={videoDescription} />
            <ProtectedRoute path="/learn/:videoID" component={VideoPage} />
          </Switch>
        </div>
      </Router>
    </UserProvider>
